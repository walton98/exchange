...
constexpr Side Side_MIN = SIDE_BUY;
...
template <> struct is_proto_enum< ::types_proto::Side> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::types_proto::Side>() {
  return ::types_proto::Side_descriptor();
}
